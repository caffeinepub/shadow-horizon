...
export default function DiscordFloatingButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {hovered && (
        <div
          className="px-3 py-1.5 rounded-lg font-orbitron text-xs text-white/90 tracking-wide"
          style={{
      ...
      <a
        ...
        className="discord-pulse w-14 h-14 rounded-full flex items-center justify-center text-white text-2xl transition-transform hover:scale-110"
        style={{
          background:
            "linear-gradient(135deg, rgba(88,101,242,0.9) 0%, rgba(168,85,247,0.9) 100%)",
          border: "2px solid rgba(168,85,247,0.5)",
        }}
        aria-label="Discord Support"
        data-ocid="discord.button"
      >
        <span className="sr-only">Discord Support</span>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
